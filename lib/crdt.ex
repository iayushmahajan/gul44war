defmodule CRDT do
  ...
  @type t :: Set_AW_OP.t() | Counter_PN_OB.t() | Behaviour_TPSet.t() | Behaviour_MVRegister.t() | Behaviour_TPSetExpanded.t()
  ...
  defguard valid?(type)
  when
    type in [Counter_PN_OB, Set_AW_OP, Behaviour_TPSet, Behaviour_MVRegister, Behaviour_TPSetExpanded]
